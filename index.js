...
// Total temperature in Fahrenheit (sum of all Fahrenheit values)
...
// Total temperature in Celsius (sum of all Celsius values)
...
console.log("Total Fahrenheit:", tot_temperature_in_fahrenheit.toFixed(1));
console.log("Total Celsius:", tot_temperature_in_celsius.toFixed(1));
console.log("Average Fahrenheit:", avg_temperature_in_fahrenheit.toFixed(1));
console.log("Average Celsius:", avg_temperature_in_celsius.toFixed(1));
